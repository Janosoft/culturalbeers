    ...
    <div class="row">
        <div class="col">
            <form action="{{ route('cervezas.update', $cerveza) }}" method="POST">
                ...
                <x-input.number label="ABV" name="ABV" min="0" max="100" step="0.5" :value="old('ABV', $cerveza->ABV)" />                
                ...
                <x-input.select label="Color" name="color_id" placeholder="Elija el color de la cerveza" :objects="$colores" :value="old('color_id', $cerveza->estilo_id)" />
                ...
                {{-- <x-input.image label="Imagen Destacada" name="imagen" :value="old('imagen')" /> TODO implementar reemplazar imagen--}}
