    ...
    <div class="row">
        <div class="col">
            <form action="{{ route('cervezas.update', $cerveza) }}" method="POST">
                ...
                <x-input.textarea label="Descripción" name="descripcion" height="87px" :value="old('descripcion', $cerveza->descripcion)" />
                ...
                <x-input.submit label="Guardar" icon="bi bi-hdd-fill" value="EditarCerveza" />
            </form>
        </div>
    </div>
@endsection
